...
public class adminlogin extends HttpServlet {
    ...
    String vADMIN_ID, vEMAIL, vPASSWORD, vFIRST_NAME, vLAST_NAME;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
               DriverManager.registerDriver(new oracle.jdbc.OracleDriver());
                ...
                vADMIN_ID = String.valueOf(numericUserID); // Convert to String if necessary
                ...
                out.println("<h2>USER_ID: " + vADMIN_ID + "</h2>");
                ...
                ops.setString(1, vADMIN_ID);
                ops.setString(2, vEMAIL);
                ops.setString(3, vPASSWORD);
                ops.setString(4, vFIRST_NAME);
                ops.setString(5, vLAST_NAME);

                int x = ops.executeUpdate();

                if (x > 0) {
                    response.sendRedirect("http://localhost:8080/TIITAWEB/Admin/loginnotify.html");
                } else {
